...
def _get_government_schemes(state: str, crop: str = None) -> List[str]:
    ...
    state_schemes = {
        ...
        "Arunachal Pradesh": ["State Horticulture Mission: Subsidized horticulture inputs"],
        "Assam": ["Assam Agricultural Subsidy Scheme: 50% subsidy on seeds and fertilizers"],
        "Bihar": ["Bihar Krishi Roadmap: Subsidized irrigation and crop inputs"],
        "Chhattisgarh": ["Rajiv Gandhi Kisan Nyay Yojana: ₹10,000/acre/year input support"],
        "Goa": ["Goa State Horticulture Mission: Support for horticulture crops"],
        "Gujarat": ["Gujarat State Crop Insurance: State-top up on PMFBY premiums"],
        "Haryana": ["Meri Fasal Mera Byora: Crop insurance and compensation scheme"],
        "Himachal Pradesh": ["Himachal Pradesh Kisan Samman Nidhi: ₹6,000/year income support"],
        "Jharkhand": ["Jharkhand SAAHAR Yojana: Subsidized food grains for farmers"],
        "Karnataka": ["Raitha Siri: Interest-free crop loans"],
        "Kerala": ["Kerala Samrudha Krishi Yojana: Comprehensive farmer support"],
        "Madhya Pradesh": ["Mukhyamantri Krishak Samman Yojana: ₹4,000/year income support"],
        "Maharashtra": ["Shetkari Sanman Yojana: ₹6000/year income support"],
        "Manipur": ["Chief Minister's Agriculture Mission: Subsidized inputs and training"],
        "Meghalaya": ["Meghalaya State Agricultural Policy: Support for organic farming"],
        "Mizoram": ["New Land Use Policy: Integrated farming system support"],
        "Nagaland": ["Nagaland Farmers' Subsidy Scheme: Subsidized fertilizers and seeds"],
        "Odisha": ["KALIA Yojana: ₹10,000/year support for small and marginal farmers"],
        "Punjab": ["Punjab Crop Diversification Programme: Incentives for alternative crops"],
        "Rajasthan": ["Mukhyamantri Kisan Samman Nidhi: ₹4,000/year income support"],
        "Sikkim": ["Sikkim Organic Mission: Premium support for organic certification"],
        "Tamil Nadu": ["TN Crop Insurance: State-subsidized crop insurance"],
        "Telangana": ["Rythu Bandhu: ₹10,000/acre/year investment support"],
        "Tripura": ["Tripura Krishi Samriddhi Yojana: Subsidized agricultural inputs"],
        "Uttar Pradesh": ["Mukhyamantri Kisan Durghatna Kalyan Yojana: Farmer accident insurance"],
        "Uttarakhand": ["Uttarakhand Kisan Saurikta Yojana: Solar pump subsidies for farmers"],
        "West Bengal": ["Bangla Shasya Bima Yojana: State crop insurance scheme"],
    }
