export const indiaLocations: Record<string, string[]> = {
  ...
  'Andhra Pradesh': [
    'Alluri Sitharama Raju', 'Anakapalli', 'Ananthapuramu', 'Annamaiah',
    'Bapatla', 'Chittoor', 'Dr. B.R. Ambedkar Konaseema', 'East Godavari',
    'Eluru', 'Guntur', 'Kakinada', 'Krishna', 'Kurnool', 'Nandyal',
    'NTR', 'Palanadu', 'Prakasam', 'Srikakulam', 'Sri Potti Sriramulu Nellore',
    'Sri Satyasai', 'Tirupati', 'Visakhapatnam', 'Vizianagaram',
  ...
  'Karnataka': [
    ...
    'Udupi', 'Uttara Kannada', 'Vijayapura', 'Yadgiri',
  ],
  'Kerala': [
  ...
  'Punjab': [
    ...
    'Rupnagar', 'SAS Nagar (Mohali)', 'Sangrur', 'Shaheed Bhagat Singh Nagar',
